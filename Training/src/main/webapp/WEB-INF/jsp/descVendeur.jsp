<div class="page-content" style="min-height: 1190px">
			...
			<div class="page-side-wrapper">
				<div class="page-content" style="min-height: 1190px">
					...
					<div class="portlet light col-md-4 col-md-offset-4">
						...
						<div class="form-group form-md-line-input">
							<div class="form-control form-control-static">
								${vendeur.nomEntreprise}</div>
							<label for="form_control_1">Nom</label>
						</div>
						

						<div class="form-actions noborder">
							<button id="retourVendeur" type="button" class="btn default">retour</button>
						</div>
 ...
 <script src="../../ressources/js/descVendeur.js" type="text/javascript"></script> 